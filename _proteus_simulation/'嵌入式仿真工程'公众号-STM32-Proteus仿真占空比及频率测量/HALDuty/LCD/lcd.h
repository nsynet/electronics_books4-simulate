...
void LCD12864_Display_Chars(unsigned char x,unsigned char y,char *dat);
void ShowGBPos(uint8_t row, uint8_t col, uint8_t *HZ);
void ShowGBStringPos(uint8_t row, uint8_t col, const char *s);
