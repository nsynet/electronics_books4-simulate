...
//#define LCD_XSIZE      320 //(128)   /* X-resolution of LCD, Logical coor. */
//#define LCD_YSIZE      240 //(128)   /* Y-resolution of LCD, Logical coor. */
#define LCD_XSIZE (320)        /* 水平分辨率X-resolution of LCD, Logical coor. */
#define LCD_YSIZE (240)        /* 垂直分辨率Y-resolution of LCD, Logical coor. */
//#define LCD_BITSPERPIXEL (8)
#define LCD_BITSPERPIXEL (16)  //16Bpp
 
#define LCD_CONTROLLER 1375 //  /*lcd控制器的具体型号*/
