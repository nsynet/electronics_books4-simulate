...
//统(0xCD,0xB3)计(0xBC,0xC6)图(0xCD,0xBC)显(0xCF,0xD4)示(0xCA,0xBE)
code struct typFNT_GB16 GB_16[] = { 
{{0xCD,0xB3},
	{0x21,0x00,0x27,0xE0,0x51,0x00,0xF2,0x00,0x24,0x40,0x47,0xE0,
	 0xF2,0x80,0x02,0x80,0x32,0xA0,0xC4,0xA0,0x18,0xE0,0x00,0x00}},
{{0xBC,0xC6},
	{0x41,0x00,0x21,0x00,0x01,0x00,0x01,0x00,0xCF,0xE0,0x41,0x00,
	 0x41,0x00,0x41,0x00,0x51,0x00,0x61,0x00,0x41,0x00,0x00,0x00}},
{{0xCD,0xBC},
	{0x7F,0xE0,0x48,0x20,0x5F,0x20,0x6A,0x20,0x44,0x20,0x4A,0x20,
	 0x75,0xA0,0x42,0x20,0x4C,0x20,0x42,0x20,0x7F,0xE0,0x00,0x00}},
{{0xCF,0xD4},
	{0x3F,0x80,0x20,0x80,0x3F,0x80,0x20,0x80,0x3F,0x80,0x00,0x00,
	 0x4A,0x40,0x2A,0x40,0x2A,0x80,0x0B,0x00,0xFF,0xE0,0x00,0x00}},
{{0xCA,0xBE},
	{0x00,0x80,0x7F,0xC0,0x00,0x00,0x00,0x00,0xFF,0xE0,0x04,0x00,
...
void Set_LCD_POS(u8 row, u8 col) {
	...
	//双参数命令,设置地址,所发送2字节数据是16位地址Addr的高8位和低8位
